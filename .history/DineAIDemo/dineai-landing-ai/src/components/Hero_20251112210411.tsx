  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary-dark via-primary to-primary-light animate-gradient">
      ...
      <div className="container relative z-10 mx-auto px-4 py-20 md:py-32">
        {/* Changed items-center -> items-start so left column stacks from top and logo sits above badge */}
        <div className="grid lg:grid-cols-2 gap-12 items-start">

          {/* Left: Text Content */}
          <div className="space-y-8">

            {/* Logo Section - now constrained and aligned with content */}
            <div className="flex items-center space-x-3 logo-wrap animate-fade-in" style={{ animationDelay: "0s" }}>
              {/* Uses public folder image /logo.png */}
              <img
                src="/.png"
                alt="DineAI Logo"
                className="h-12 w-auto md:h-14 lg:h-16 max-w-[180px] object-contain drop-shadow-lg"
              />
            </div>
      ...
      <style jsx>{`
        ...
        /* slightly slower, smoother logo appearance */
        .logo-wrap { opacity: 0; transform: translateY(6px); animation: fadeInUp 0.85s forwards; }
      `}</style>
    </section>
  );
};
