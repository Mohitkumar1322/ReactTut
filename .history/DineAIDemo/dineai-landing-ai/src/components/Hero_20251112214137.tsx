...
<header className="absolute top-6 left-0 right-0 z-40">
  {/* fixed height container ensures logo and toggle align to same baseline */}
  <div className="container mx-auto px-4 flex items-center justify-between h-20 md:h-24">
    ...
    <a href="/" className="flex items-center gap-3 h-full">
      <img
        src="/logo.png"
        alt="DineAI"
        /* width-based sizing tends to be more reliable for varying aspect ratios */
        className="w-48 md:w-56 lg:w-64 max-h-20 object-contain drop-shadow-xl"
        style={{ height: "auto" }}
      />
    </a>
    ...
    <nav className="hidden md:flex items-center gap-6">
      ...
      <a href="#request-demo" className="ml-2">
        <Button
          size="sm"
    ...
    <div className="md:hidden flex items-center">
      ...
      >
        {/* show hamburger or close depending on open state */}
      ...
      <div className="container relative z-10 mx-auto px-4 py-20 md:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div className="inline-block px-4 py-2 bg-secondary/20 backdrop-blur-sm rounded-full border border-secondary/30 animate-fade-in"></div>

            <h1
              className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 animate-fade-in leading-tight"
