...
const RightCard = () => {
  return (
    <div className='h-full w-80 rounded-4xl'>
        ...
        <div className='p-4'>
            <h2 className='text-black text-2xl font-bold mb-2'>Card Title</h2>
            <p className='text-white text-base'>This is a description of the card. It provides additional information about the content of the card.</p>
        </div>
